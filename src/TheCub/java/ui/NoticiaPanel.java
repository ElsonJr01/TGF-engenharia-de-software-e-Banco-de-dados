...
public class NoticiaPanel extends JPanel {
     ...
     */
    public NoticiaPanel(Usuario usuario) {
    ...
    private void inicializarComponentes() {
        ...
        // Título no topo
        JLabel lblTitulo = new JLabel("Gerenciamento de Noticia", SwingConstants.CENTER);
            ...
            protected Void doInBackground() {
                try {
                    ...
                    if (connection.getResponseCode() == 200) {
                        ...
                        StringBuilder texto = new StringBuilder("📰 Noticia Recentes:\n\n");
