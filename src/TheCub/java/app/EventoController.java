...
import servicos_tecnicos.EventoService;
...
public class EventoController {
    ...
    public ResponseEntity<EventoResponseDTO> criarEvento(
            @Valid @RequestBody EventoRequestDTO dto // Dados do evento vindo do frontend
    ) {
    ...
    public ResponseEntity<EventoService.EventoEstatisticas> estatisticas() {
