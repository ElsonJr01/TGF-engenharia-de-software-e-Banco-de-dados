...
public class AvaliacaoNoticia {
    ...
    public AvaliacaoNoticia() {}

    // Construtor de conveniência para criar uma avaliação
    public AvaliacaoNoticia(Usuario usuario, Noticia artigo, TipoAvaliacao avaliacao) {
    ...
    public Noticia getArtigo() { return artigo; }
    public void setArtigo(Noticia artigo) { this.artigo = artigo; }
