...
public interface ComentarioRepository extends JpaRepository<Comentario, Long> {
    ...
    List<Comentario> findByArtigo(Noticia artigo);

    List<Comentario> findByArtigoAndAprovadoTrueOrderByDataComentarioDesc(Noticia artigo);

    Page<Comentario> findByArtigoAndAprovadoTrue(Noticia artigo, Pageable pageable);
    ...
    Long countByArtigo(Noticia artigo);

    Long countByArtigoAndAprovadoTrue(Noticia artigo);
